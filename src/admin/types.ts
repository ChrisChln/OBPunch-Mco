...
export type TimecardRow = {
  ...
  lateByDay: boolean[]; // 0..6 (Mon..Sun)
  lateMinutesByDay: number[]; // 0..6 (Mon..Sun)
  lateSourceByDay: string[]; // 0..6 (Mon..Sun)
  lateRoundingFamilyByDay: string[]; // 0..6 (Mon..Sun)
  lateLearnedExpectedStartRawByDay: string[]; // 0..6 (Mon..Sun)
  lateLearnedExpectedStartRoundedByDay: string[]; // 0..6 (Mon..Sun)
  lateGuardrailExpectedStartByDay: string[]; // 0..6 (Mon..Sun)
  lateFinalExpectedStartByDay: string[]; // 0..6 (Mon..Sun)
  lateFirstInByDay: string[]; // 0..6 (Mon..Sun)
  lateSampleCountByDay: number[]; // 0..6 (Mon..Sun)
