...
export function MagicSingleSelect<Value extends string>({
  ...
  const { rootRef, open, setOpen } = useDismissableMenu();
  ...
  return (
    <div ref={rootRef} className={['relative', className].join(' ')}>
      ...
      {open ? (
        <MenuSurface tone={tone} className="absolute left-0 top-[calc(100%+8px)] z-50 w-full min-w-[180px]">
          <div role="listbox" className="magic-select-menu max-h-64 space-y-1 overflow-auto p-2">
            <button
              type="button"
              role="option"
              aria-selected={!value}
...
export function MagicMultiSelect<Value extends string>({
  ...
  return (
    <div ref={rootRef} className={['relative', className].join(' ')}>
      ...
      {open ? (
        <MenuSurface tone={tone} className="absolute left-0 top-[calc(100%+8px)] z-50 w-full min-w-[212px]">
          <div className="p-2.5">
