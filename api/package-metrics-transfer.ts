...
import { createServiceSupabase, ensureCron, parseJsonBody } from './_forecastShared.js';
...
const handlePackageStaffingSync = async (req: any, res: any) => {
...
export default async function handler(req: any, res: any) {
  if (String(req.query?.job ?? '') === 'package-staffing-sync') {
    await handlePackageStaffingSync(req, res);
    return;
  }
